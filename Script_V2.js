...
function UpdateContent(Data) {
    ...
    for (const Item of Data.Header.Navigation) {
        var MH_NavItem = document.createElement("a");
        MH_NavItem.className = "MH_NavItem";
        MH_Navigation.appendChild(MH_NavItem);

        var MH_NavItem_Icon = document.createElement(Item?.IconIsImage ? "img" : "i");
        MH_NavItem_Icon.className = "MH_NavItem_Icon";
        if (Item?.IconIsImage) {
            MH_NavItem_Icon.src = Item.Icon;
        } else {
            MH_NavItem_Icon.classList.add("fa-solid");
            MH_NavItem_Icon.classList.add(Item.Icon);
        }
        MH_NavItem.appendChild(MH_NavItem_Icon);

        var MH_NavItem_Text = document.createElement("p");
        MH_NavItem_Text.innerText = Item.Label;
        MH_NavItem.appendChild(MH_NavItem_Text);
    }
}
...
function InitializeContent() {
    ...
    UpdateContent(Content.GER);
}

function ChangeLanguage(Lang) {
    // Start Transition Animation

    // Delayed Language Change
